package com.example.pd.user.service;
...
import com.example.pd.user.mapper.IUserMapper;
...
public class UserService {
    ...
    public void recoverPassword(PasswordRecoverVo passwordRecoverVo) throws MessagingException {
        ...
        helper.setText(String.format("<a href=\"localhost/verify-password-recover?code=%s\" target=\"_blank\" style=\"font-size: 1rem;\">이메일 확인하기</a>",
                //clientModel.getUrlPrefix(),
